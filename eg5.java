...
{
System.out.println("Foreign key table name : "+resultSet.getString("fktable_name"));
System.out.println("Foreign key column name : "+resultSet.getString("fkcolumn_name"));
}
resultSet.close();
